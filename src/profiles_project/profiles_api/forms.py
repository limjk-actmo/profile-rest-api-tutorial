...
class ResetPasswordForm(forms.Form):
    ...
    def clean_email(self):
        ...
        try:
            condition = User.objects.get(email__iexact=self.cleaned_data["email"], is_active=True).count()
        except:
            raise forms.ValidationError("Email address not verified for any user account")
